...
tally supports **17/22** BuildKit checks:

- **5** captured during parsing
- **12** reimplemented by tally (BuildKit normally runs these during LLB conversion)
- **5** not currently supported (LLB conversion only)
- **10** with auto-fixes (🔧)

...
| [DL3022](https://github.com/hadolint/hadolint/wiki/DL3022) | `COPY --from` should reference a previously defined `FROM` alias | Off | ✅ `hadolint/DL3022` (off by default; does not account for `--build-context` sources) |

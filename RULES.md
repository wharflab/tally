...
tally supports **20/22** BuildKit checks:

- **5** captured during parsing
- **15** reimplemented by tally (BuildKit normally runs these during LLB conversion)
- **2** not currently supported (LLB conversion only)
- **10** with auto-fixes (🔧)

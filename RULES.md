...
tally supports **21/22** BuildKit checks:

- **5** captured during parsing
- **16** reimplemented by tally (BuildKit normally runs these during LLB conversion)
- **1** not currently supported (LLB conversion only)
- **10** with auto-fixes (🔧)

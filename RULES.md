...
tally supports **11/22** BuildKit checks:

- **5** captured during parsing
- **6** reimplemented by tally (BuildKit normally runs these during LLB conversion)
- **11** not currently supported (LLB conversion only)
- **5** with auto-fixes (🔧)

---
title: "tally/prefer-vex-attestation"
description: "Prefer attaching OpenVEX VEX documents as OCI attestations instead of copying `*.vex.json` into the image filesystem."
---
...
See: [https://docs.docker.com/scout/how-tos/create-exceptions-vex/](https://docs.docker.com/scout/how-tos/create-exceptions-vex/)
...
- Docker Scout VEX exceptions: [https://docs.docker.com/scout/how-tos/create-exceptions-vex/](https://docs.docker.com/scout/how-tos/create-exceptions-vex/)

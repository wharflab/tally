---
title: "tally/prefer-wget-config"
...
- [`hadolint/DL3047`](../hadolint/DL3047) checks `wget` command progress output
- [`tally/prefer-add-unpack`](./prefer-add-unpack) rewrites `wget` download-and-extract
  patterns to `ADD --unpack`
- [`tally/prefer-copy-heredoc`](./prefer-copy-heredoc) detects file creation via `RUN`

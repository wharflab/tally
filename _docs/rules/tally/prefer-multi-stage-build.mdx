---
title: "`tally/prefer-multi-stage-build`"
description: "Suggests converting Dockerfiles that **build artifacts in a single stage** into a **multi-stage build** to reduce the final image size and avoid"
---

---
title: "tally/no-trailing-spaces"
...
Use [EditorConfig integration](/integrations/editorconfig) to configure IDEs and editors to trim trailing whitespace before tally reports it.

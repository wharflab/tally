---
title: "buildkit/MultipleInstructionsDisallowed"
description: "Multiple CMD instructions should not be used in the same stage because only the last one will be used."
---

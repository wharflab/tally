---
title: "Installing BuildKit for Windows Containers"
description: "Set up a standalone BuildKit daemon for Windows containers and connect docker buildx with the remote driver."
---

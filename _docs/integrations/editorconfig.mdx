...
| `trim_trailing_whitespace` | Structured serializers decide the payload whitespace they emit; tally does not run a separate trailing-whitespace pass based on this property. |

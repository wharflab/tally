...
func TestPreferCurlConfigRule_FallbackWithoutFacts(t *testing.T) {
	t.Parallel()
...
func TestPreferCurlConfigRule_FallbackPackageInstall(t *testing.T) {
	t.Parallel()
...
func TestPreferCurlConfigRule_FallbackNoTrigger(t *testing.T) {
	t.Parallel()

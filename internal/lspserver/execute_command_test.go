...
func TestParseApplyAllFixesArgs(t *testing.T) {
	...
	tests := []struct {
		...
		},
		{
			...
			args:       ptrTo([]any{"file:///tmp/Dockerfile"}),
		...
		},
		{
			...
			args:       ptrTo([]any{"file:///tmp/Dockerfile", true}),
			wantURI:    "file:///tmp/Dockerfile",
			wantUnsafe: true,
			wantOK:     true,
		},
		{
			...
			args:       ptrTo([]any{"file:///tmp/Dockerfile", "nope"}),
			wantURI:    "file:///tmp/Dockerfile",
			wantUnsafe: false,
			wantOK:     true,
		},
		...
		{
			name:       "map uri only",
			args:       ptrTo([]any{map[string]any{"uri": "file:///tmp/Dockerfile"}}),
			wantURI:    "file:///tmp/Dockerfile",
			wantUnsafe: false,
			wantOK:     true,
		},
		{
			...
			args:       ptrTo([]any{map[string]any{"uri": "file:///tmp/Dockerfile", "unsafe": true}}),
			wantURI:    "file:///tmp/Dockerfile",
			wantUnsafe: true,
			wantOK:     true,
		},
		{
			...
			args:       ptrTo([]any{map[string]any{"unsafe": true}}),
			wantURI:    "",
			wantUnsafe: false,
			wantOK:     false,
		},
		{
			...
			args:       ptrTo([]any{map[string]any{"uri": 123}}),
			wantURI:    "",
			wantUnsafe: false,
			wantOK:     false,
		},
		{
			name:       "map uri empty",
			args:       ptrTo([]any{map[string]any{"uri": ""}}),
			wantURI:    "",
			wantUnsafe: false,
			wantOK:     false,
		},
		{
			...
			args:       ptrTo([]any{map[string]any{"uri": "file:///tmp/Dockerfile", "unsafe": "nope"}}),
			wantURI:    "file:///tmp/Dockerfile",
			wantUnsafe: false,
			wantOK:     true,
		},

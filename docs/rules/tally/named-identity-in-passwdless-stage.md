...
- [`tally/shell-run-in-scratch`](./shell-run-in-scratch.md) -- detects shell-form RUN in scratch
  stages (different concern: shell availability vs identity resolution)
- [`tally/copy-after-user-without-chown`](./copy-after-user-without-chown.md) -- detects missing
  `--chown` after `USER` (complementary: different condition)
- [`tally/user-created-but-never-used`](./user-created-but-never-used.md) -- detects created
